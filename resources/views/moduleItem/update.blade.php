...
@section('title', 'ModuleItem | update')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.moduleitem.update', [$modules->slug, $modules->id]) }}">{{ $modules->name }} updaten</a></li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <form action="{{ route('admin.moduleitem.put', [$modules->slug, $item]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="box box-primary" style="border-top-color: #1AA650;">
            ...
            <div class="form-group">
                @csrf
                <input type="submit" name="submit" class="btn btn-succes" value="Module updaten" />
            </div>
        </div>
