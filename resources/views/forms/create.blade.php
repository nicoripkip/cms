...
@section('title', 'Formulieren | create')
@section('content')
  @parent
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.forms.create') }}">Formulieren aanmaken</a></li>
    </ol>
  </section>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="icon" class="form-control" placeholder="Icoon.." required />
                    </div>
                    <!-- Email bevestiging -->
                    <div class="form-group">
                    ...
                    <div id="email-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email[email]" class="form-control" placeholder="Email adres.." />
                        </div>
                        <!-- ApiToken -->
                        <div class="form-group">
                            <label class="form-text">Api Token: </label>
                            <input type="text" name="email[token]" class="form-control" placeholder="Api token.." />
                        </div>
                        <!-- Subject -->
                        <div class="form-group">
                            <label class="form-text">Subject: </label>
                            <input type="text" name="email[subject]" class="form-control" placeholder="Subject.." />
                        </div>
                        <!-- Text -->
                        <div class="form-group">
                            <label class="form-text">Text: </label>
                            <input type="text" name="email[text]" class="form-control" placeholder="Subject.." />
                        </div>
                    </div>
                </div>
                <!-- Column 2 -->
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        @csrf
                        <input type="submit" name="submit" class="btn btn-success pull-right" value="Formulieren opslaan" />
                    </div>
                </div>
            </div>
        </form>
